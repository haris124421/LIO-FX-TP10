...
describe('Protocol', ()=> {
    ...
    it('TC 1.21.1 it should add Protocol successfully', () => {
        cy.request({
            method : 'PUT',
            url: Cypress.env('BASEURL')+'/LIOWebAPI/api/ProtocolEditor',
            ...
            cy.writeFile('cypress/fixtures/api_data/protocol.json',response.body)
        })
    }) 
})