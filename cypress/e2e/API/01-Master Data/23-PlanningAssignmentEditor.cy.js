...
describe('Planning Assignment', ()=> {

    it('TC 1.23.1 it should add Planning Assignment successfully', () => {
        cy.request({
            method : 'PUT',
            url: Cypress.env('BASEURL')+'/LIOWebAPI/api/PlanningAssignmentEditor',
            ...
            cy.writeFile('cypress/fixtures/api_data/planningAssignment.json',response.body)
        })
    }) 
})